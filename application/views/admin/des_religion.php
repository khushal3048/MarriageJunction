                     ...
                     <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <tbody aria-relevant="all" aria-live="polite" role="alert">
                                        ...
                                        ?>
											<tr class="odd">
                                                <td class="  sorting_1"><?=$value['religion_id'];?></td>
                                                <td class=" "><?=$value['religion_name'];?></td>
                                                <td align="center"><a href="<?php echo base_url('admin_operation/des_rel?id=').$value['religion_id'];?>"><i class="fa fa-trash-o"></i></a></td>
