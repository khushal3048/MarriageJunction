                    ...
                    <div class="col-xs-12">
                     <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">SubCaste List</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    ...
                                    <tbody aria-relevant="all" aria-live="polite" role="alert">
                                        <?php foreach ($subcaste_details as $value) {
                                            # code...
                                        ?>
											<tr class="odd">
                                                <td class="  sorting_1"><?=$value['sub_caste_id'];?></td>
                                                <td class=" "><?=$value['sub_caste_name'];?></td>
                                                <td align="center"><a href="<?php echo base_url('admin_operation/des_subcaste?id=').$value['sub_caste_id'];?>"><i class="fa fa-trash-o"></i></a></td>
